...
Crie um script que avise quando o Dog já passeou o suficiente. Para saber, vamos considerar que ele se sentirá satisfeito somente a 
partir de 5 voltas na quadra.
...
let voltasSuficientes = 5
let volta = 1

while(volta <= voltasSuficientes) {
    console.log(`Volta nº ${volta} com o Dog`)
    volta++
}

console.log(`O Dog já passeou o suficiente`)
